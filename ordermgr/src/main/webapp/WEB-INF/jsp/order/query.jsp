...
<script type="text/javascript">
	$().ready(function(){
		$("#btn_query").click(function(){
			var json ='{"customerPid":"'+$("#customerPid").val()+'","orderTime":"'+$("#orderTime").val()+'","totalMoney":"'+$("#totalMoney").val()+'","saveMoney":"'+$("#saveMoney").val()+'","state":"'+$("#state").val()+'"}';
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" class="tableLine">
	<tr>
		...
		<tr>
	<td>客户编号</td>
	<td><input type="text" id="customerPid" name="customerPid" ></td>
	<td>下订单时间</td>
