...
<script type="text/javascript">
	$().ready(function(){
		$("#btn_query").click(function(){
			var json ='{"orderPid":"'+$("#orderPid").val()+'","goodsPid":"'+$("#goodsPid").val()+'","orderNum":"'+$("#orderNum").val()+'","price":"'+$("#price").val()+'","money":"'+$("#money").val()+'","saveMoney":"'+$("#saveMoney").val()+'"}';
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" class="tableLine">
	<tr>
		...
		<tr>
	<td>订单编号</td>
	<td><input type="text" id="orderPid" name="orderPid" ></td>
	<td>商品编号</td>
	<td><input type="text" id="goodsPid" name="goodsPid" ></td>
	</tr>
<tr>
	<td>购买数量</td>
